...
class lab091
{
    ...
    static async Task Main()
    {
        ...
        using (StreamReader reader = new StreamReader("C:/Users/User/source/repos/C-lab-09-master/C-lab-09-master/ticker.txt"))
        {
            string line;
    ...
    static async Task GetDataForTicker(HttpClient client, string ticker)
    {
        try
        {
            ...
            if (totalRowCount > 0)
            {
                ...
                try
                {
                    File.AppendAllText("C:/Users/User/source/repos/C-lab-09-master/C-lab-09-master/results.txt", result + Environment.NewLine);
                }
                finally
                {
                    mutex.ReleaseMutex();
